...
class Product(models.Model):
    store_menu = models.ForeignKey(StoreMenu, on_delete=models.CASCADE,related_name='store_product')
...
class CourierProduct(models.Model):
    ...
    courier_status = models.CharField(max_length=20)
...
class Review (models.Model):
    ...
    courier = models.ForeignKey(UserProfile, on_delete=models.CASCADE, related_name='courier_review', null=True, blank=True)
